...
What is kept, and why (design-handoff/tokens/type.css):
  ...
  Ranges    Google Fonts' latin and latin-ext splits, matching the
            unicodeRange in theme.json — plus U+2190-2199 (→ ← ↗, set in
            Inter via .ot-arrow; Google's latin range only carries ↑ ↓) and
            U+2713 (✓ in form validation), which the old site's
            scripts/fonts/subset.sh also kept for the same reason. Without
            them the browser draws those characters from a fallback face.
            Matching the
...
LATIN = "U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2190-2199,U+2212,U+2215,U+2713,U+FEFF,U+FFFD"
