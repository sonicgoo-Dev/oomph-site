	...
	private static function write_italy( int $id ): void {
		...
		Fields::write_repeater(
			...
			array(
				...
				array( 'question' => 'How far ahead should I start?', 'answer' => 'For spring and fall in the popular regions, six to nine months is comfortable; the villas and guides worth having book early. I’ve turned around shorter timelines, but the runway buys you the good options.' ),
