...
| **D44** | The Journal index and article follow CruiseOomph's Cruise Journal layout (navy hero beside the newest photograph, pill topic chips, panelled cards, story hero beside its picture, author box, the advisor's invitation card), with that site's rounded corners on these two pages only. The Figma Journal index and Journal article frames are superseded; Card / Journal on the homepage is unchanged. Shipped as theme 0.10.0 (#150). | Eric, Sep 16 |
