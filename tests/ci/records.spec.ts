...
test.describe( 'placeholders must never reach a rendered page', () => {
  for ( const path of [ '/destinations/italy/', '/', '/escorted-tours/', '/escorted-tours/globus/', '/tours/globus-rome-florence-venice/', '/custom-journeys/', '/resorts-and-villas/', '/multi-generational-travel-planning/', '/cruise-planning/', '/start-planning/', '/about/', '/client-stories/', '/journal/', '/travel-trends/' ] ) {
